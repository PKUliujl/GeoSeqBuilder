...
2. Change the PATH of dssp in the [line 158 and 511](https://github.com/PKUliujl/geoseqbuilder/Utils/pdb_processor.py) to your own path if the given dssp does not work.
